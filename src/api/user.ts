 ...
 */
export const userPlayHistory = (params: { uid: number, type: number }) => {
    return request({
        url: '/user/record',
        method: 'get',
        params,
 ...
 * @param {number} type
 */
export const dailySignin = (type: number = 0) => {
    return request({
        url: '/daily_signin',
        method: 'post',
        params: {
 ...
 * 说明 : 调用此接口可获取到用户收藏的歌手
 */
export const likedArtists = (params: { limit: number }) => {
    return request({
        url: '/artist/sublist',
        method: 'get',
        params: {
 ...
 * 说明 : 调用此接口可获取到用户收藏的MV
 */
export const likedMVs = (params: { limit: number }) => {
    return request({
        url: '/mv/sublist',
        method: 'get',
        params: {
 ...
 * 获取云盘歌曲详情（需要登录）
 */
export const cloudDiskTrackDetail = (id: any) => {
    return request({
 ...
 * @param {Array} id
 */
export const cloudDiskTrackDelete = (id: any) => {
    return request({
        url: '/user/cloud/del',
        method: 'get',
        params: {
