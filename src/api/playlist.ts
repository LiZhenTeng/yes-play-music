 ...
 */
export const getHighQualityPlaylist = (params: { cat?: string, limit?: number, before: number }) => {
    return request({
 ...
 * @param {number=} params.limit
 */
export const getTopPlaylist = (params: { order?: 'new' | 'hot', cat?: string, limit?: number, offset?: number }) => {
    return request({
        url: '/top/playlist',
        method: 'get',
        params,
