...
export const authGetSession = (token: string) => {
    const signature = md5(
...
export const trackUpdateNowPlaying = (params: { [x: string]: any; api_key?: any; method?: any; sk?: any; }) => {
...
export const trackScrobble = (params: { [x: string]: any; api_key?: any; method?: any; sk?: any; }) => {
    params.api_key = apiKey;
