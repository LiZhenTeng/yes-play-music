    ...
    <div>
        <nav :class="{ 'has-custom-titlebar': hasCustomTitlebar }">
            ...
            <div class="navigation-buttons">
                <button-icon @click.native="go('back')"><svg-icon icon-class="arrow-left" /></button-icon>
                <button-icon @click.native="go('forward')"><svg-icon icon-class="arrow-right" /></button-icon>
            </div>
            ...
            <div class="right-part">
                <div class="search-box">
                    <div class="container" :class="{ active: inputFocus }">
                        ...
                        <div class="input">
                            <input ref="searchInput" v-model="keywords" type="search"
                                :placeholder="inputFocus ? '' : $t('nav.search')" @keydown.enter="doSearch"
...
const doSearch = () => {
    ...
    if (
        route.name === 'search' &&
        route.params.keywords === keywords.value
    ) {
        return;
    }
    router.push({
