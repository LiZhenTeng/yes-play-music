            ...
            <div class="section-2">
                <div v-show="mode === 'phone'" class="input-box">
                    <div class="container" :class="{ active: inputFocus === 'phone' }">
                        ...
                        <div class="inputs">
                            <input id="countryCode" v-model="countryCode" :placeholder="
...
const qrCodeKey = ref('');
const qrCodeSvg = ref('');
const qrCodeCheckInterval = ref<NodeJS.Timer | null>(null);
...
onMounted(() => {
    if (['phone', 'email', 'qrCode'].includes(route.query.mode?.toString() || '')) {
